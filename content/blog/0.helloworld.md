...
---
  ## Outro
Congratulations, you have made it this far! Give yourself a pat on the back, you have just done something the majority of people wouldn't bother with. You have created a blog, this is the most valuable type of social media one can have. To make sure that you don't miss any of my other publications, follow my [RSS](https://vladisl0th.github.io/blog/index.xml) feed, you can read up on the options of how you can set one up for your own blog [here](https://makewithhugo.com/add-an-rss-feed/). 
...
The biggest problem with modern social media like TikTok isn't the loss of attention spans, or even the fact that governments use it to push there own agenda onto populous.
